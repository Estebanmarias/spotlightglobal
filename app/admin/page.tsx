...
export default function AdminLoginPage() {
  ...
  return (
    <main className="flex-grow flex items-center justify-center px-4 py-12 min-h-screen bg-[#f7f9fb]">
      {/* Ambient blobs */}
      <div className="absolute top-0 left-0 w-[500px] h-[500px] bg-[#081534]/5 rounded-full blur-[100px] -translate-x-1/2 -translate-y-1/2" />
      <div className="absolute bottom-0 right-0 w-[400px] h-[400px] bg-[#fdc425]/8 rounded-full blur-[80px] translate-x-1/2 translate-y-1/2" />
      ...
      >
        ...
        <div className="mb-10 text-center flex flex-col items-center">
          <img
            ...
            alt="Logo" className="h-24 w-auto mb-6"
          />
          <h1 className="text-[32px] font-bold text-[#081534] mb-2">Administrative Portal</h1>
          <p className="text-[16px] text-[#45464e]">Shine Your Light. Manage Your Mission.</p>
        </div>

        {/* Card */}
        <div className="w-full bg-white border border-[#c6c6cf] rounded-xl p-8 md:p-10 shadow-sm">
          <form onSubmit={handleLogin} className="space-y-6">
            ...
            <div>
              <div className="flex justify-between items-center mb-2">
                <label className="text-[14px] font-semibold text-[#081534]">Security Password</label>
