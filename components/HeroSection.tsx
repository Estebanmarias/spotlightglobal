    ...
    <header className="relative w-full h-[870px] overflow-hidden flex items-center">
      ...
      <div className="absolute inset-0 z-0">
        ...
        <div className="absolute inset-0"
          style={{ background: 'linear-gradient(to right, rgba(8,21,52,0.9), rgba(8,21,52,0.4))' }} />
      </div>
      ...
      <div className="relative z-10 px-16 w-full max-w-[1280px] mx-auto text-white">
        <div className="max-w-2xl">
          ...
          >
            We are a People Marvelously Helped, Greatly Blessed, <br /> Deeply Loved and Highly Favored.
          </motion.p>
