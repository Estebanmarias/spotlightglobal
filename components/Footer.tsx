...
const socials = [
  {
    name: 'WhatsApp', href: 'https://wa.me/YOUR_NUMBER',
  ...
  {
    name: 'YouTube', href: 'https://www.youtube.com/@pstedetkingsley',
    path: 'M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z',
  },
  {
    name: 'Instagram', href: 'https://instagram.com/thespotlightchurch', gradient: true,
  ...
  {
    name: 'TikTok', href: 'https://tiktok.com/@yourhandle',
  ...
  {
    name: 'Spotify', href: 'https://open.spotify.com/show/75PSP2x3mArsPABn4KReUY',
      ...
      <div className="px-4 sm:px-8 lg:px-16 py-12 sm:py-16 w-full max-w-[1280px] mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            ...
            <Link href="/join"
              className="inline-block mt-5 bg-[#fdc425] text-[#6d5200] px-6 py-2.5 rounded-full text-[13px] font-bold hover:brightness-110 transition-all active:scale-95">
              Join Us
            </Link>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              <li>
                <Link href="/join" className="text-[14px] text-white/70 hover:text-white transition-colors">
                  Become a Member
                </Link>
              </li>
              <li>
                <Link href="/partner" className="text-[14px] text-white/70 hover:text-white transition-colors">
                  Partnership
                </Link>
              </li>
              <li>
                <Link href="/giving" className="text-[14px] font-semibold text-[#fdc425] hover:brightness-110 transition-all">
                  Give Now
                </Link>
              </li>
            </ul>
        ...
        <div className="border-t border-white/10 pt-8 flex flex-col sm:flex-row items-center justify-between gap-6">
          ...
          <p className="text-white/50 text-[12px] text-center sm:text-left">
            © 2026 theSpotlightChurch. Company of the Blessed.
          </p>
              ...
              <a key={s.name} href={s.href} target="_blank" rel="noreferrer" aria-label={s.name}
                ...
                {s.icon ? (
                  ...
                  <svg viewBox="0 0 24 24" className="w-4 h-4">
                    <defs>
                      <linearGradient id={`footer-ig-${i}`} x1="0%" y1="100%" x2="100%" y2="0%">
                        <stop offset="0%" stopColor="#f09433"/><stop offset="50%" stopColor="#dc2743"/><stop offset="100%" stopColor="#bc1888"/>
                      </linearGradient>
                    </defs>
                    <path fill={`url(#footer-ig-${i})`} d={s.path} />
                  </svg>
                ) : (
                  <svg viewBox="0 0 24 24" className="w-4 h-4 fill-white group-hover:fill-[#6d5200] transition-colors">
                    <path d={s.path} />
                  </svg>
                )}
              </a>
